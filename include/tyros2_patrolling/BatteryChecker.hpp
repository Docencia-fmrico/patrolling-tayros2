...
#ifndef TYROS2_PATROLLING__BATTERYCHECKER_HPP_
#define TYROS2_PATROLLING__BATTERYCHECKER_HPP_
...
{
public:
  explicit BatteryChecker(const std::string & xml_tag_name, const BT::NodeConfiguration & conf);
...
#endif  // TYROS2_PATROLLING__BATTERYCHECKER_HPP_
