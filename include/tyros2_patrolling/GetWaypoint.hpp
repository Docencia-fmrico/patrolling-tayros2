...
#ifndef TYROS2_PATROLLING__GETWAYPOINT_HPP_
#define TYROS2_PATROLLING__GETWAYPOINT_HPP_
...
{
public:
  explicit GetWaypoint(const std::string & xml_tag_name, const BT::NodeConfiguration & conf);
...
#endif  // TYROS2_PATROLLING__GETWAYPOINT_HPP_
